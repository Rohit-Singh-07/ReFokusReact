...
function Cards() {
  return (
    <div className="flex justify-center text-white gap-1 font-['satoshi'] mt-3">
      <div className="justify-start w-[30vw] h-[25vw] bg-zinc-800 rounded-xl p-5 hover:p-6">
      ...
      <div className="justify-start w-[58vw] h-[25vw] bg-zinc-700 rounded-xl p-5 hover:p-6 hover:bg-violet-600">
        <div className="flex justify-between h-[14%]">
          <h3>Get in touch</h3>
          <HiOutlineArrowNarrowRight />
        </div>
